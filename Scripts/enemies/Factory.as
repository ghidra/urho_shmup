...
class Factory:ScriptObject{
    ...
    void generate_enemy_factory(const Vector3&in pos = Vector3(), const int&in spawnamount=5, const float&in spawninterval=1.0f, const String&in etype = "Enemy",const String&in wtype = "Weapon", const String&in btype="Behavior", const float&in fire_rate= 1.0f, const int&in mirror = 0,const float&in active_time=1.0f){
